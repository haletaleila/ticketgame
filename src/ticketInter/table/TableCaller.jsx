        ...
        <tr>
          <td valign="top" style={{ padding: "20px" }} nowrap="true">
            ...
            <map name="Map">
              <area
                shape="poly"
                coords="227,226,252,204,295,192,292,203,286,230,275,257"
                onfocus="this.blur()"
              ...
              <area
                shape="poly"
                coords="208,256,225,233,248,246,270,260,243,305,199,278"
                onfocus="this.blur()"
              ...
              <area
                shape="poly"
                coords="194,284,248,313,217,323,207,346,196,339,189,311"
                onfocus="this.blur()"
